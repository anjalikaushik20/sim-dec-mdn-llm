...
# Only the LLMValueNetwork adapters, action_embed, and q_head are trained — backbone frozen.
...
from models.llm_model_ac import LLMValueNetwork
...
class CB_Session(object):
    ...
    def dm_train_epoch(self):
        ...
        loss = F.cross_entropy(q_values, a_star_batch, label_smoothing=0.05)
    ...
    def dm_test(self, mode="test"):
        ...
        with torch.no_grad():
            ...
            action = value_network_output.argmax(dim=1)

...
from sessions.cb_session_llm_sgro import CB_Session
...
def parse_args():   
    ...
    parser.add_argument('--precompute_rewards', action='store_true', help='Force recomputation of reward matrices even if cached files exist')

#!/bin/bash
# Sample-efficiency sweep for Qwen/Qwen3-1.7B — DataCo + GlobalStore (GPU 0).
# Split from run_sample_efficiency_qwen3_17b.sh for 2-GPU parallelism.
# Companion: run_sample_efficiency_qwen3_17b_oas_scsp.sh (GPU 1)
#
...
echo "=========================================="
echo " Sample efficiency — ${MODEL_TAG} (DataCo + GlobalStore)"

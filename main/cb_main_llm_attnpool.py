...
from sessions.cb_session_llm_attnpool import CB_Session
...
info("Training: frozen backbone → learned attention pooling over all positions → cls_head (4 logits) | Inference: forward() + argmax")
# ----------------------------------- Session Init -----------------------------------------------------------
info('--------------------------------Session Init------------------------------')

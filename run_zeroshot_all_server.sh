...
BASE_OUT_DIR="/data/akaush39/sim-to-dec/output/latest_output/zero_shot/${RUN_ID}"
mkdir -p "${BASE_OUT_DIR}"

echo "Zero-shot evaluation — all models × {DataCo, GlobalStore, OAS}"
echo "Models: Qwen3-0.6B, Qwen3-1.7B, Qwen3-4B, GPT-2, GPT-2 Medium, GPT-2 Large"
echo "All runs sequential on GPU 1"
